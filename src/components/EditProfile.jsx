...
const EditProfile = () => {
  ...
  return (
    ...
    <div className='fixed z-50 inset-0 overflow-y-auto'>
      <div className='flex items-centr justify-center min-h-screen pt-4
      px-4 pb-20 text-center sm:block sm:p-0'>
        ...
        <div className='inline-block align-bottom bg-primary rounded-lg text-left
        ...
        aria-labelledby='modal-headline'>
            ...
            onSubmit={handleSubmit(onSubmit)}>
              ...
              <TextInput
               ...
               error={errors.lasttName ? errors.lasttName?.message:""}
              />
              <TextInput
                label="Profession"
               styles='w-full'
